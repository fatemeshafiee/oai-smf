...
void PduSessionCreateData::setEpsInterworkingInd(EpsInterworkingIndication const& value)
{
...
void PduSessionCreateData::setRoamingChargingProfile(RoamingChargingProfile const& value)
{
