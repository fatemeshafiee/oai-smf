...
std::vector<QosFlowAddModifyRequestItem>& VsmfUpdateData::getQosFlowsAddModRequestList()
{
...
std::vector<QosFlowReleaseRequestItem>& VsmfUpdateData::getQosFlowsRelRequestList()
{
