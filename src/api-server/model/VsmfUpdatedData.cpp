...
std::vector<SecondaryRatUsageReport>& VsmfUpdatedData::getSecondaryRatUsageReport()
{
...
std::vector<SecondaryRatUsageInfo>& VsmfUpdatedData::getSecondaryRatUsageInfo()
{
