...
void HsmfUpdateData::setEpsInterworkingInd(EpsInterworkingIndication const& value)
{
...
std::vector<SecondaryRatUsageReport>& HsmfUpdateData::getSecondaryRatUsageReport()
{
