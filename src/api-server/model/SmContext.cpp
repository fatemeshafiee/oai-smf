...
MaxIntegrityProtectedDataRate SmContext::getMaxIntegrityProtectedDataRate() const
{
    return m_MaxIntegrityProtectedDataRate;
}
void SmContext::setMaxIntegrityProtectedDataRate(MaxIntegrityProtectedDataRate const& value)
{
