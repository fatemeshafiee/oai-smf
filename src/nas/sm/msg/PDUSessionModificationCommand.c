  ...
  while (len - decoded > 0) {
    ...
    switch (ieiDecoded & 0xf0) {
      case PDU_SESSION_MODIFICATION_COMMAND_ALWAYSON_PDU_SESSION_INDICATION_IEI:
        if ((decoded_result = decode_alwayson_pdu_session_indication(&pdu_session_modification_command->alwaysonpdusessionindication,
                                                                     PDU_SESSION_MODIFICATION_COMMAND_ALWAYSON_PDU_SESSION_INDICATION_IEI, buffer + decoded, len - decoded)) < 0)
    ...
    switch (ieiDecoded) {
      ...
      case PDU_SESSION_MODIFICATION_COMMAND_QOS_FLOW_DESCRIPTIONS_IEI:
        if ((decoded_result = decode_qos_flow_descriptions(&pdu_session_modification_command->qosflowdescriptions, PDU_SESSION_MODIFICATION_COMMAND_QOS_FLOW_DESCRIPTIONS_IEI, buffer + decoded,
                                                           len - decoded)) < 0)
          return decoded_result;
        else {
          decoded += decoded_result;
      ...
      case PDU_SESSION_MODIFICATION_COMMAND_E_P_C_O_IEI:
        if ((decoded_result = decode_extended_protocol_configuration_options(&pdu_session_modification_command->extendedprotocolconfigurationoptions, PDU_SESSION_MODIFICATION_COMMAND_E_P_C_O_IEI,
...
int encode_pdu_session_modification_command(pdu_session_modification_command_msg *pdu_session_modification_command, uint8_t *buffer, uint32_t len) {
  ...
  if ((pdu_session_modification_command->presence & PDU_SESSION_MODIFICATION_COMMAND_ALWAYSON_PDU_SESSION_INDICATION_PRESENCE)
      == PDU_SESSION_MODIFICATION_COMMAND_ALWAYSON_PDU_SESSION_INDICATION_PRESENCE) {
    if ((encoded_result = encode_alwayson_pdu_session_indication(pdu_session_modification_command->alwaysonpdusessionindication, PDU_SESSION_MODIFICATION_COMMAND_ALWAYSON_PDU_SESSION_INDICATION_IEI,
  ...
  if ((pdu_session_modification_command->presence & PDU_SESSION_MODIFICATION_COMMAND_QOS_FLOW_DESCRIPTIONS_PRESENCE) == PDU_SESSION_MODIFICATION_COMMAND_QOS_FLOW_DESCRIPTIONS_PRESENCE) {
    if ((encoded_result = encode_qos_flow_descriptions(pdu_session_modification_command->qosflowdescriptions, PDU_SESSION_MODIFICATION_COMMAND_QOS_FLOW_DESCRIPTIONS_IEI, buffer + encoded,
                                                       len - encoded)) < 0)
      return encoded_result;
    else
      encoded += encoded_result;
  ...
  if ((pdu_session_modification_command->presence & PDU_SESSION_MODIFICATION_COMMAND_E_P_C_O_PRESENCE) == PDU_SESSION_MODIFICATION_COMMAND_E_P_C_O_PRESENCE) {
    if ((encoded_result = encode_extended_protocol_configuration_options(pdu_session_modification_command->extendedprotocolconfigurationoptions, PDU_SESSION_MODIFICATION_COMMAND_E_P_C_O_IEI,
                                                                         buffer + encoded, len - encoded)) < 0)
      return encoded_result;
    else
      encoded += encoded_result;
