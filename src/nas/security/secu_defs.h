...
int nas_stream_encrypt_nia1(nas_stream_cipher_t * const stream_cipher, uint8_t const out[4]);

int nas_stream_encrypt_nea2(nas_stream_cipher_t * const stream_cipher, uint8_t * const out);

int nas_stream_encrypt_nia2(nas_stream_cipher_t * const stream_cipher, uint8_t const out[4]);
