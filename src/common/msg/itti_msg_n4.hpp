...
class itti_n4_msg : public itti_msg {
 public:
  ...
  itti_n4_msg(const itti_n4_msg& i, const task_id_t orig, const task_id_t dest) : itti_n4_msg(i)  {
    origin = orig;
    destination = dest;
  }
...
class itti_n4_heartbeat_request : public itti_n4_msg {
 public:
  ...
  itti_n4_heartbeat_request(const itti_n4_heartbeat_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }

  const char* get_msg_name() {return typeid(itti_n4_heartbeat_request).name();};
...
class itti_n4_heartbeat_response  : public itti_n4_msg {
 public:
  ...
  itti_n4_heartbeat_response(const itti_n4_heartbeat_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_heartbeat_response(const itti_n4_heartbeat_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_heartbeat_response).name();};
...
class itti_n4_pfcp_pfd_management_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_pfcp_pfd_management_request(const itti_n4_pfcp_pfd_management_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_pfcp_pfd_management_request).name();};
...
class itti_n4_pfcp_pfd_management_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_pfcp_pfd_management_response(const itti_n4_pfcp_pfd_management_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_pfcp_pfd_management_response).name();};
...
class itti_n4_association_setup_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_setup_request(const itti_n4_association_setup_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_setup_request).name();};
...
class itti_n4_association_setup_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_setup_response(const itti_n4_association_setup_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_setup_response).name();};
...
class itti_n4_association_update_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_update_request(const itti_n4_association_update_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_update_request).name();};
...
class itti_n4_association_update_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_update_response(const itti_n4_association_update_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_update_response).name();};
...
class itti_n4_association_release_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_release_request(const itti_n4_association_release_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_release_request).name();};
...
class itti_n4_association_release_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_association_release_response(const itti_n4_association_release_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_association_release_response(const itti_n4_association_release_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_association_release_response).name();};
...
class itti_n4_version_not_supported_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_version_not_supported_response(const itti_n4_version_not_supported_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_version_not_supported_response(const itti_n4_version_not_supported_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_version_not_supported_response).name();};
...
class itti_n4_node_report_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_node_report_request(const itti_n4_node_report_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_node_report_request(const itti_n4_node_report_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_node_report_request).name();};
...
class itti_n4_node_report_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_node_report_response(const itti_n4_node_report_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_node_report_response(const itti_n4_node_report_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_node_report_response).name();};
...
class itti_n4_session_set_deletion_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_set_deletion_request(const itti_n4_session_set_deletion_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_set_deletion_request(const itti_n4_session_set_deletion_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_set_deletion_request).name();};
...
class itti_n4_session_set_deletion_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_set_deletion_response(const itti_n4_session_set_deletion_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_set_deletion_response(const itti_n4_session_set_deletion_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_set_deletion_response).name();};
...
class itti_n4_session_establishment_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_establishment_request(const itti_n4_session_establishment_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_establishment_request(const itti_n4_session_establishment_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_establishment_request).name();};
...
class itti_n4_session_establishment_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_establishment_response(const itti_n4_session_establishment_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_establishment_response(const itti_n4_session_establishment_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_establishment_response).name();};
...
class itti_n4_session_modification_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_modification_request(const itti_n4_session_modification_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_modification_request(const itti_n4_session_modification_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_modification_request).name();};
...
class itti_n4_session_modification_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_modification_response(const itti_n4_session_modification_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_modification_response(const itti_n4_session_modification_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_modification_response).name();};
...
class itti_n4_session_deletion_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_deletion_request(const itti_n4_session_deletion_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_deletion_request(const itti_n4_session_deletion_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_deletion_request).name();};
...
class itti_n4_session_deletion_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_deletion_response(const itti_n4_session_deletion_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_deletion_response(const itti_n4_session_deletion_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_deletion_response).name();};
...
class itti_n4_session_report_request   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_report_request(const itti_n4_session_report_request& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_report_request(const itti_n4_session_report_request& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_deletion_request).name();};
...
class itti_n4_session_report_response   : public itti_n4_msg {
 public:
  ...
  itti_n4_session_report_response(const itti_n4_session_report_response& i) : itti_n4_msg(i) {
    pfcp_ies = i.pfcp_ies;
  }
  itti_n4_session_report_response(const itti_n4_session_report_response& i, const task_id_t orig, const task_id_t dest) :
    itti_n4_msg(i, orig, dest)  {
    pfcp_ies = i.pfcp_ies;
  }
  const char* get_msg_name() {return typeid(itti_n4_session_report_response).name();};
