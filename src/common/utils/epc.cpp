...
std::string Utility::tai_fqdn(const char *lb, const char *hb, const char *mnc,
  ...
  s.append("tac-lb").append(lb).append(".tac-hb").append(hb).append(".tac.epc.")
      .APPEND_MNC( mnc ).APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::mme_fqdn(const char *mmec, const char *mmegi,
  ...
  s.append("mmec").append(mmec).append(".mmegi").append(mmegi).append(
      ".mme.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::mme_pool_fqdn(const char *mmegi, const char *mnc,
  ...
  s.append("mmegi").append(mmegi).append(".mme.epc.").APPEND_MNC( mnc ).
      APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::rai_fqdn(const char *rac, const char *lac, const char *mnc,
  ...
  s.append("rac").append(rac).append(".lac").append(lac).append(".rac.epc.")
      .APPEND_MNC( mnc ).APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::rnc_fqdn(const char *rnc, const char *mnc,
  ...
  s.append("rnc").append(rnc).append(".rnc.epc.").APPEND_MNC( mnc ).
      APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::sgsn_fqdn(const char *nri, const char *rac,
  ...
  s.append("nri").append(nri).append(".rac").append(rac).append(".lac").append(
      lac).append(".rac.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).
      APPEND_3GPPNETWORK;
...
std::string Utility::epc_node_fqdn(const char *node, const char *mnc,
  ...
  // '^(.+)\.node\.epc\.mnc(\d{3})\.mcc(\d{3})\.3gppnetworks\.org$'
  s.append(node).append(".node.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).
      APPEND_3GPPNETWORK;
...
std::string Utility::nonemergency_epdg_oi_fqdn(const char *mnc,
  ...
  s.append("epdg.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).append("pub.")
      .APPEND_3GPPNETWORK;
...
std::string Utility::nonemergency_epdg_tai_fqdn(const char *lb, const char *hb,
  ...
  s.append("tac-lb").append(lb).append(".tac-hb").append(hb).append(
      ".tac.epdg.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).APPEND_3GPPNETWORK;
...
std::string Utility::nonemergency_epdg_lac_fqdn(const char *lac,
  ...
  s.append("lac").append(lac).append(".epdg.epc.").APPEND_MNC( mnc ).
      APPEND_MCC( mcc ).append("pub.").APPEND_3GPPNETWORK;
...
std::string Utility::nonemergency_epdg_visitedcountry_fqdn(const char *mcc) {
  ...
  s.append("epdg.epc.").APPEND_MCC( mcc ).append("visited-country.pub.")
      .APPEND_3GPPNETWORK;
...
std::string Utility::emergency_epdg_oi_fqdn(const char *mnc, const char *mcc) {
  ...
  s.append("sos.epdg.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).append("pub.")
      .APPEND_3GPPNETWORK;
...
std::string Utility::emergency_epdg_tai_fqdn(const char *lb, const char *hb,
  ...
  s.append("tac-lb").append(lb).append(".tac-hb").append(hb).append(
      ".tac.sos.epdg.epc.").APPEND_MNC( mnc ).APPEND_MCC( mcc ).append("pub.")
      .APPEND_3GPPNETWORK;
...
std::string Utility::emergency_epdg_lac_fqdn(const char *lac, const char *mnc,
  ...
  s.append("lac").append(lac).append(".sos.epdg.epc.").APPEND_MNC( mnc ).
      APPEND_MCC( mcc ).append("pub.").APPEND_3GPPNETWORK;
...
std::string Utility::emergency_epdg_visitedcountry_fqdn(const char *mcc) {
  ...
  s.append("sos.epdg.epc.").APPEND_MCC( mcc ).append("visited-country.pub.")
      .APPEND_3GPPNETWORK;
...
std::string Utility::global_enodeb_id_fqdn(const char *enb, const char *mcc) {
  ...
  s.append("enb").append(enb).append(".enb.epc.").APPEND_MCC( mcc ).append(
      "visited-country.pub.").APPEND_3GPPNETWORK;
...
std::string Utility::local_homenetwork_fqdn(const char *lhn, const char *mcc) {
  ...
  s.append("lhn").append(lhn).append(".lhn.epc.").APPEND_MCC( mcc ).append(
      "visited-country.pub.").APPEND_3GPPNETWORK;
